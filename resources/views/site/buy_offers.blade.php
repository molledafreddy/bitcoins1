                                    ...
                                    <div class="card-action" style="border-bottom: 1px solid rgba(160, 160, 160, 0.2);">
                                        <a href="#" target="new_blank" >
                                            <div class="wheel-header">
                                                <center>
                                                    <h3 style="padding-bottom:0px" >Ofertas de Compra</h3>
                                                    <h3 class="font-15 " style="padding: 0px"> Tienes <span><b> pesos</b></span> y deseas comprar <span><b>Bitcoins</b> </span></h3>
                                                </center>
                                            </div>
                                        </a>
                                    </div>
