				...
				<div class="col-md-12" style="padding-bottom:20px">
					<div class="card">
						<div class="card-action" style="border-bottom: 1px solid rgba(160, 160, 160, 0.2);">
							<a href="#" target="new_blank" >Comprar Bitcoins</a>
						</div>
								...
								<div class="tab-pane fade active in" id="seller">
									...
									<div class="wheel-register-log labele" style="background-color:white; padding: 0px">
										<div class="card-content">
											<form  class="form-process-buy" role="form" method="POST" action="{{ route('offers.async', 'buy_offer_pay') }}">
												...
												<div class="row">
								                    ...
								                    <div class="col-md-12 m-t-20">
								                    	<div class="alert alert-info" role="alert">
								                    		<h4>Debes realizar la transferencia de los pesos a la cuenta seleccionada y una vez realizada la transferencia poner el codigo de la transaccion en el campo indicado mas abajo, una vez completado el proceso, un moderador revisara la transaccion y transferira los fondos a tu cuenta bancaria.</h4>
								                    ...
								                    <div class="col-md-12 col-xs-12 m-t-20 m-b-50">
								                    	@if (count($paymentDatas)>0)
																...
																@endforeach
								                    	@endif
															@if ($errors->has('paymentBuy'))
																<div class="alert alert-danger" role="alert">{{ $errors->first('paymentBuy') }}</div>
															@endif
							                    	</div>
