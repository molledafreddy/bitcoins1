...
<!-- Notification 1  -->
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="full"  bgcolor="#f2f4f9"style="background-color: rgb(242, 244, 249);">
      ...
      <table width="100%" border="0" cellpadding="0" cellspacing="0" align="center" class="mobile">
        <tbody><tr>
          <td width="100%" height="100" align="center">
            ...
            <!-- Shadow -->
            <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" class="full" style="-webkit-border-radius: 6px; -moz-border-radius: 6px; border-radius: 6px;">
              <tbody><tr>
                    ...
                    <tbody><tr>
                      <td width="100%" valign="middle" align="center">
                        ...
                        <table width="600" border="0" cellpadding="0" cellspacing="0" align="center" style="text-align: center; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;" class="fullCenter">
                          ...
                          <tr>
                            <td valign="middle" width="100%" style="text-align: center; font-family: 'Open Sans', Helvetica, Arial, sans-serif; font-size: 21px; color: rgb(255, 255, 255); line-height: 30px; font-weight: 600;" class="fullCenter"mc:edit="1" >
                             Bitcoin Bogota.co
                            </td>
                          </tr>
                          <tr>
...
</tbody></table><!-- End Notification 1 -->

<!-- Notification 2  -->
<div style="display: none;" id="element_05104327597655356"></div><!-- End Notification 2 -->

<!-- Notification 3  -->
<div style="display: none;" id="element_05297016173135489"></div><!-- End Notification 3 -->

<!-- Notification 4  -->
<div style="display: none" id="element_018846075469627976"></div><!-- End Notification 4 -->

<!-- Notification 5  -->
<div style="display: none" id="element_034061694075353444"></div><!-- End Notification 5 -->

<!-- Notification 6  -->
<div style="display: none" id="element_08582775322720408"></div><!-- End Notification 6 -->
